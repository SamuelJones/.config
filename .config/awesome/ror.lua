...
-- Usual attributes are "class","instance", or "name". If no attribute is given it defaults to 
-- "class".
...
--WM_NAME(STRING) gives you the name of the selected window (usually something like the web page 
--title for browsers, or the file name for emacs).
